...
export default function Hint() {
  ...
  return (
    ...
    >
      ...
      <g id="Layer_6" data-name="Layer 6" transform="translate(-70,-102.53562)">
        <path
          className="cls-2"
          d="M 387,189.5 H 98.46 A 8,8 0 0 1 92,176.7 l 33.55,-42.08 A 8,8 0 0 1 132,131.4 h 285.84 a 8,8 0 0 1 6.49,12.7 l -30.82,42.08 A 8,8 0 0 1 387,189.5 Z"
          id="path210"
        />
